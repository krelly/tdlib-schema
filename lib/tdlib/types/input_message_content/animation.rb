module TD::Types
  ...
  # @attr thumbnail [TD::Types::InputThumbnail, nil] Animation thumbnail; pass null to skip thumbnail uploading.
  ...
  # @attr caption [TD::Types::FormattedText, nil] Animation caption; pass null to use an empty caption;
