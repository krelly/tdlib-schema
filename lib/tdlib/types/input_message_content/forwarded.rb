module TD::Types
  ...
  #   messages.
  # @attr copy_options [TD::Types::MessageCopyOptions, nil] Options to be used to copy content of the message without
  ...
  class InputMessageContent::Forwarded < InputMessageContent
    ...
    attribute :copy_options, TD::Types::MessageCopyOptions.optional.default(nil)
  end
end
