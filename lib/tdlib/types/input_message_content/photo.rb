module TD::Types
  ...
  # @attr thumbnail [TD::Types::InputThumbnail, nil] Photo thumbnail to be sent; pass null to skip thumbnail uploading.
  ...
  # @attr caption [TD::Types::FormattedText, nil] Photo caption; pass null to use an empty caption;
