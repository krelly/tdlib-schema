module TD::Types
  ...
  # @attr thumbnail [TD::Types::InputThumbnail, nil] Document thumbnail; pass null to skip thumbnail uploading.
  ...
  # @attr caption [TD::Types::FormattedText, nil] Document caption; pass null to use an empty caption;
